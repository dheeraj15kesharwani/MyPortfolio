...
function Header() {
  ...
  window.addEventListener("scroll", function (){
      ...
      // when the scroll is higher than 200 viewport hieght, add the 
  ...
  return (
    <header className="header">
      <nav className="nav container">
        {/* Add class to hide logo when menu is open */}
        <a href="index.html" className={`nav__logo ${Toggle ? 'hide' : ''}`}> Dheeraj <i class="uil uil-user"></i> </a>
        ...
        {/* Toggle icon with conditional hide */}
        <div className={`nav__toggle ${Toggle ? 'hide' : ''}`} onClick={() => showMenu(!Toggle)}>
